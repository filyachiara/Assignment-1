...
3. Jika lebih dari 9 maka akan muncul output Filya Chiara Amanda sampai ke 100
```sh
   else {
   System.out.println("Filya Chiara Amanda");
}
   ```
...
```sh
   Scanner scanner = new Scanner(System.in);
        ...
        System.out.print("Masukkan tanggal lahir (contoh: 18 5 untuk tanggal 18 Mei): ");
        day = scanner.nextInt();
